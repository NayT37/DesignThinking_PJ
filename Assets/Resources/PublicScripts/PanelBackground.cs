...
public class PanelBackground : MonoBehaviour
{
    ...
    private void Initializate()
    {
        ...
        _canClose = false;
        _nextBtn = transform.GetChild(0).GetChild(2).Find("NextBtn").gameObject;
        _backBtn = transform.GetChild(0).GetChild(2).Find("BackBtn").gameObject;
        _exitBtn = transform.GetChild(0).Find("ExitCanvas").gameObject;
